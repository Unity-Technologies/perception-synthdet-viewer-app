...
| Installation | <ul><li>Install the app from the [App Store](https://apps.apple.com/app/id1528361585) (recommended), or</li><li> Build from source with the steps in [How to Build](https://github.com/Unity-Technologies/perception-synthdet-viewer-app/blob/master/docs/how-to-build.md)</li></ul> |
